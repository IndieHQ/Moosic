...
<p class="ml-4">
1. Moosic: The Multipurpose Discord bot and all it's versions 
</p>
...
<p class="ml-4">
Discord data is stored to make sure Moosic can operate and allow servers to set their own settings.<br>
</p>
<p class="font-semibold text-gray-200 mt-4">2. Opt-in</p>
<div class="ml-4">
...
are needed to make sure the settings you set persist over your period of time using Moosic within
your server.
</p>
</div>
</div>
